...
public class AsyncActionHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
        ...
        if (bundle != null) {
            actionHandler.doActionResponse(bundle.getInt(ACTION_STATUS), bundle.getString(ACTION_MESSAGE),
                    bundle.getSerializable(ACTION_RESULT));
            actionHandler.doActionRawData(bundle.getString(ACTION_DATA), bundle.getString(ACTION_MESSAGE));
        }
    }
}
